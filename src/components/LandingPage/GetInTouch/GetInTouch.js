...
function GetInTouch() {
  return (
    <>
      <div className="get-in-touch-section section text-center pt-5 pb-4 custom-section">
        <Container className="card p-5">
          ...
          <p className="text-left pt-4">
            ...
            your resources by yourself or letting us do it for you,” either way,
            in this model, our consultants work for you from our office.
      ...
      <section className="py-4 section-bubble3">
        <div className="container">
          ...
          <p className="pt-3">
            ...
            goal by delivering niche support and services in the field of IT and
            Non-IT having a back-up team of equally qualified and efficient
            Developers, Programmers, Strategic Planners who invest their entire
            knowledge and resources in understanding the ever growing trends and
            area to area economic development and help create a bridge to
            satisfy the demands of our Clients globally.
          </p>
          <Row className="pt-5">
            <Col md="2">
